...
import { ButtonPrimary, ButtonDanger, ButtonInfo, ButtonWarning } from "@/components/button" //nambain ingpo
                   ...
                   <div className="p-5">
                       <InputGroupComponent id={`name`} type="text" value={user.name}
                           ...
                           <Select id={`role`} value={user.role} label="Role"
                               ...
                               <option value="CHASIER">Cashier</option>
                           </Select>
                           ...
                           <FileInput acceptTypes={["application/pdf", "image/png", "image/jpeg", "image/jpg"]} id="profile_picture"
                            ...
                            {!showPassword && (
                                <ButtonWarning type="button" onClick={() => changePassword()}>
